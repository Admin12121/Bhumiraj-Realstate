...
/**
 * Severity is derived from the action name, not stored.
 *
 * Anything that removes access, moves ownership or bans an account is the set
 * you scan for first; state changes are the middle; creation and acceptance are
 * routine. Deriving it keeps the badge honest about what the log records --
 * there is no severity column behind it.
 */
