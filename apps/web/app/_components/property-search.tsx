...
export function PropertySearch({
  ...
  function submit(event: FormEvent) {
    ...
    const query = new URLSearchParams({ type: listingType })
  ...
  return (
    ...
    >
      <div className="flex min-h-[52px] w-full items-center rounded-[6px] bg-white px-3 lg:w-[20%]">
        ...
        >
          <SelectTrigger
            ...
            className="h-auto w-full border-0 bg-transparent px-0 text-[14px] font-medium text-[#1d1919] shadow-none outline-none focus-visible:border-0 focus-visible:ring-0 before:shadow-none!"
          >
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="mt-1 flex min-h-[52px] min-w-0 flex-1 items-center rounded-[6px] bg-white px-3 lg:mt-0 lg:ml-1">
        ...
        <input
          ...
          placeholder="Location, district or city"
          autoComplete="off"
          className="h-full min-w-0 flex-1 bg-transparent text-[14px] font-medium text-[#1d1919] outline-none placeholder:text-[#737373]"
        />
      </div>

      <div className="mt-1 flex min-h-[52px] w-full items-center rounded-[6px] bg-white px-3 lg:mt-0 lg:ml-1 lg:w-[24%]">
      ...
      <div className="mt-1 flex lg:mt-0 lg:ml-1">
        <button
          type="submit"
          className="inline-flex min-h-[52px] w-full items-center justify-center gap-2 rounded-[6px] bg-emerald-600 px-6 text-[17px] font-medium leading-7 text-white transition-colors hover:bg-emerald-700 focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:outline-none lg:w-auto"
        >
